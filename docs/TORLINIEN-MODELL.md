...
gespeichert. Nach `npm run settle` werden alle sechs binären Ereignisse anhand der Tore
nach regulärer Spielzeit abgerechnet. `npm run report` zeigt Stichprobe, Ereignisquote,
